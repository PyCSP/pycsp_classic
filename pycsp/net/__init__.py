...
class RemoteChannelAdapter(_forwardMixin, Channel):
...
class LocalChannelAdapter(_forwardMixin, Channel):
    ...
    def isInputGuard(self):
        ...
        return isinstance(self._chan.read, Guard)
